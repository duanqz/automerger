    ...
    render: function () {
        if (!this.state.login) {
            if(location.hash != '') {
                ...
                location.href = "http://gitlab.meizu.com/oauth/authorize?client_id=28cc0f2b06ea4e33b37bc017d443973527aeec7508e3233d9e4827c3991f974c&redirect_uri=http://duanqz.github.io/automerger&response_type=token"
            }
